...
# Same endpoints as v23, but the middle/lower rows turn at x19 instead of x20. This removes
# exactly two carrying cells while preserving every room and pin coordinate.
GATE_DRUM = [(25, 13), (1, 13), (1, 14), (19, 14), (19, 15), (1, 15)]
...
def build() -> tuple[str, dict[str, int]]:
    ...
    # only cost latency. This probe retains four cells over the measured ~84-tick loader drain.
