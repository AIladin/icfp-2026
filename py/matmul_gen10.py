...
RB_DRUM = (34, 42, 19, 25)   # bottom-right feed, top-left return; no row-44 hook
...
def build() -> tuple[str, dict[str, int]]:
    ...
    wire("A", (17, 10), (25, 23), drum=A_DRUM, via=[(17, 12), (13, 12)], via2=A_SNAKE)
    wire("gate", (23, 10), (18, 17), drum=gd, via=[(23, 12), (26, 12)], via2=[(1, 16), (18, 16)])
    wire("pk", (29, 10), (34, 5), via=[(29, 12), (34, 12)])
    wire("padk", (41, 5), (40, 14), via=[(41, 7)])
    wire("rf", (27, 17), (35, 14), via=[(27, 15)])
    wire("ring", (37, 16), (31, 17), drum=rb,
         via=[(37, 18), (42, 18), (42, 14), (43, 14), (43, 18), (43, 43)],
         via2=[(33, 19), (33, 16), (31, 16)])
    wire("prod", (26, 23), (28, 26), via=[(26, 25)])
