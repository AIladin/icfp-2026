...
RB_DRUM = (33, 41, 18, 25)   # bottom-right feed, top-left return; no row-43 hook
...
def build() -> tuple[str, dict[str, int]]:
    ...
    wire("pk", (29, 10), (34, 5), via=[(29, 12), (33, 12), (33, 6), (34, 6)])
    wire("padk", (41, 5), (39, 13), via=[(41, 7)])
    wire("rf", (26, 17), (34, 13), via=[(26, 15)])
    wire("ring", (36, 15), (30, 17), drum=rb,
         via=[(36, 17), (41, 17), (41, 13), (42, 13), (42, 17), (42, 42)],
         via2=[(32, 18), (32, 16), (30, 16)])
    wire("prod", (25, 23), (26, 26), via=[(25, 25)])
    wire("accf", (20, 36), (20, 39))
    wire("accb", (16, 41), (14, 36),
         via=[(15, 41), (15, 42), (10, 42), (10, 38), (14, 38), (14, 37)])
    wire("out", (10, 35), (7, 39), via=[(8, 35), (8, 38), (7, 38)])
