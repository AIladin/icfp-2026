"""snake gen58 — compact west loops and shift width setters across drops.
...
BLOCKS = [
    ...
    ("DIRA",
     ...
     " M L64",                          # DIRB swaps/divides after the drop
     "j", ("DIRB",)),
    ("DIRB",
     "W / N s"                          # divide Z by 64, then DX'
    ...
    def build(self):
        ...
        for blk in BLOCKS:
            ...
            if kind == "westdir":
                ...
                x = self.dirb_entry
                self.put(x, y, "<")
                for ch in expand("W / N s r r s r W N s r s r s"):
                    x -= 1
                    self.put(x, y, ch)
