"""snake gen85 — execute DIRA's shift prelude on its incoming wire.
...
BLOCKS = [
    ...
    ("DIRA",
     "L257986880 }"                     # A = TABLE >> 8(V-2); B came from entry
...
INX, INY = 15, 14                    # input room B+15 .. B+17, rows 14..16
...
def build(audit: bool = False) -> str:
    ...
    px([(18, 15), (19, 15), (19, 8), (18, 8)], final=(-1, 0), want=10, name="input")
