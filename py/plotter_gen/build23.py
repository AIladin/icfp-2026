"""Combined 44x44 narrow-room plotter candidate.
...
def build(w: int = 44, setup_h: int = 17, swap_right: int = 12) -> str:
...
if __name__ == "__main__":
    ...
    swap_right = int(sys.argv[4]) if len(sys.argv) > 4 else 12
