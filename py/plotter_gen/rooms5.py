...
# The counted forwarding loop carries 38 values: two reload pairs, four eastward
# passes of six pairs and three westward passes of four. The original P,P,P,Q,Q router
# stays unchanged, matching prog4's two final rotations without changing any pipe port.
ECHO_ROWS = [
    "   v<            ",
    "    ^sRsR<       ",
    "         ^sRsRsR<",
