...
RB_DRUM = (35, 44, 20, 25)   # x35..44 y20..44, 10 x 25 = 250
...
def build() -> tuple[str, dict[str, int]]:
    ...
    wire("in", (2, 1), (14, 1), via=[(13, 1)])
    wire("A", (16, 10), (26, 23), drum=A_DRUM, via=[(16, 12), (13, 12)], via2=A_SNAKE)
    wire("gate", (22, 10), (19, 17), drum=gd, via=[(22, 12), (26, 12)], via2=[(1, 16), (19, 16)])
    wire("pk", (28, 10), (35, 5), via=[(28, 12), (35, 12)])
    wire("padk", (42, 5), (41, 15), via=[(42, 7)])
    wire("rf", (28, 17), (36, 15), via=[(28, 15)])
    wire("ring", (38, 17), (32, 17), drum=rb,
         via=[(38, 19), (45, 19), (45, 44)], via2=[(34, 20), (34, 16), (32, 16)])
    wire("prod", (27, 23), (28, 26), via=[(27, 25)])
    wire("accf", (22, 38), (22, 41))
    wire("accb", (23, 43), (16, 38), via=[(25, 43), (25, 45), (15, 45), (15, 39)])
    wire("out", (14, 38), (10, 42), via=[(14, 41), (11, 41)])
