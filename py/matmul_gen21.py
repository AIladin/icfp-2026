...
# Same endpoints as v19, but the middle/lower rows turn at x20 instead of x25.  This removes
# exactly ten carrying cells while preserving every room and pin coordinate.
GATE_DRUM = [(25, 13), (1, 13), (1, 14), (20, 14), (20, 15), (1, 15)]
...
A_DRUM = [(12, 3), (3, 3), (3, 4), (0, 4), (0, 5), (11, 5), (11, 6), (0, 6), (0, 7), (12, 7),
...
def build() -> tuple[str, dict[str, int]]:
    ...
    wire("out", (9, 34), (6, 36), via=[(7, 34), (7, 35), (6, 35)])
