...
RB_DRUM = (32, 40, 17, 25)   # bottom-right feed, top-left return; no row-42 hook
...
def build() -> tuple[str, dict[str, int]]:
    ...
    wire("pk", (29, 10), (34, 5), via=[(29, 12), (32, 12), (32, 6), (34, 6)])
    wire("padk", (41, 5), (37, 10), via=[(41, 7), (37, 7), (37, 9)])
    wire("rf", (26, 17), (34, 12), via=[(26, 15), (33, 15), (33, 12)])
    wire("ring", (36, 14), (30, 17), drum=rb,
         via=[(36, 16), (40, 16), (40, 8), (41, 8), (41, 16), (41, 41)],
         via2=[(32, 16), (30, 16)])
    wire("prod", (25, 23), (26, 26), via=[(25, 25)])
    wire("accf", (20, 36), (21, 39), via=[(20, 37), (22, 37), (22, 39)])
    wire("accb", (16, 40), (14, 36),
         via=[(15, 40), (15, 41), (10, 41), (10, 38), (14, 38), (14, 37)])
    wire("out", (10, 35), (7, 38), via=[(8, 35), (8, 37), (7, 37)])
