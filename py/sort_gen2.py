...
def build() -> str:
    ...
    c.room(4, 12, 6, 4)
    c.text(5, 13, "@>rv")  # `@` sits outside the shuttle; he enters it and never leaves
    c.text(6, 14, "^s<")

    # The ring: 13 cells out, 5 back = 18, exactly the 16 values plus M and C.  Two rules bite
