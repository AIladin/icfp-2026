...
def apply_chain() -> list:
    ...
    return [
        ...
        ("TAQ", "M 2 - N M r ~", "x",
         (None, ("1 N s", "JOIN"), ("~ s 1 s r s 1 s 1 N s", "JOIN"))),
        ...
        ("JOIN", "@LOOP W s W s 1 s W s 1 s 9 s " + SWAP0, "j", ("MAIN",)),
    ]
...
BLOCKS = [
    ...
    ("MAIN", VREQ + " r s r s r s r s r s @LOOP s 1 M r -",
     "x", ("TCHK", "FRUITA", "DIRA")),
    ...
    ("FRUITA", "2 s 3 s r s r s r s r s r s M 1 +", "cond",
     ("1 s W s 1 s 1 N s", "@LOOP s", "FRUITB")),
    ...
    ("FRUITB", "r M r + M 2 + N M"      # B = -(16*fy + fx + 2)
               " r s r s r s r s"       # DX HX DP HP unchanged
               " r W M s",              # drop the old F, send the new one
     "j", ("FRUITC",)),
    ("FRUITC", "1 s W s 1 s 8 s"        # paint the new fruit red, once
               " @LOOP s " + SWAP0,
     "j", ("MAIN",)),
...
def build(audit: bool = False) -> str:
    ...
    boxes = {
        ...
        "HUB": (B + HUBX, HUBY, B + HUBX + 18, HUBY + 11),
    ...
    px([(0, 2), (17, 2), (17, 1), (1, 1), (1, 0), (18, 0), (18, 4), (10, 4)],
       final=(0, 1), want=RING, name="ring")
    px([(4, 4), (4, 3), (0, 3)], final=(-1, 0), want=RING_IN, name="ring-in")
    px([(16, 18), (16, 17)], final=(0, -1), want=2, name="input")
    ...
    px([(4, 17), (4, 23), (2, 23), (2, 26)], final=(1, 0), want=12, name="feed")
    ...
    px([(14, 27), (15, 27), (15, 35), (1, 35), (1, 46)], final=(1, 0), want=35, name="DATA")
    px([(5, 32), (5, 34), (0, 34), (0, 55), (11, 55)], final=(0, -1), want=40, name="SWAP")
    if audit:
        report(c, boxes, laid)
    return c.render()
