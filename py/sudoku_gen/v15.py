"""H15: route PHASE's output south into HEAD.

PHASE moves left and HEAD's lower group moves down one row, making a two-cell straight
PHASE-to-HEAD pipe. OUTPUT moves with HEAD, preserving verdict-pipe latency.
"""
...
if __name__ == "__main__":
    ...
    emit(sys.argv[1] if len(sys.argv) > 1 else "v15.man")
    print(render())
