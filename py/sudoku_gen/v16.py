"""H16: move INPUT northeast to shorten INPUT-to-MASK to two cells.

All H15 rooms and other pipes stay fixed. INPUT occupies otherwise unused space east
of PHASE and feeds MASK through the minimum-length straight pipe.
"""
...
# The V10 ring, shifted down with HEAD and RELAY.
put(14, 13, ">")
put(14, 14, "v")
put(15, 14, "|")
put(16, 14, "|")
...
if __name__ == "__main__":
    ...
    emit(sys.argv[1] if len(sys.argv) > 1 else "v16.man")
    print(render())
