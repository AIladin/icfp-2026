"""H13: H12 with PHASE shifted west to shorten its critical output pipe.
...
# PHASE west -> HEAD north, one cell shorter than H12.
path_pipe([(9, 9), (9, 8), (11, 8)])
vpipe(1, 11, 10)
