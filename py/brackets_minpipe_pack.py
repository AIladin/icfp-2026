"""Hand-place the safe pipeline in 16x16 with all four pipes at minimum length."""
...
from brackets_stack3_local_sentinel_gen import build as build_stack
...
def main() -> None:
    ...
    parser.add_argument(
        "--out",
        type=Path,
        default=ROOT / "programs" / "brackets" / "v36-minpipe-16x16.man",
    )
