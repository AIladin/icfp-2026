...
GREEN = "L256 s L11 s"                # DATA 11 -> colour 10
RED = "L256 s L10 s"                  # DATA 10 -> colour 9
...
def apply_chain(sfx: str, pre: str) -> list:
    ...
    return [
        ...
        ("TAPG" + sfx, "L257 N s @LOOP W s W s", "j", ("PAINT" + sfx + "G",)),
    ] + paint_chain(sfx + "G")
...
def over_chain(sfx: str, discard: str) -> list:
    ...
    return [
        ...
        ("OVF" + sfx, "r M L257 +", "x", (None, "OVB" + sfx, "OVFR" + sfx)),
        ("OVFR" + sfx, "L256 s W s W s L10 s", "j", ("OVB" + sfx,)),
...
def paint_chain(sfx: str) -> list:
    ...
    return [
        ...
        ("PAINT" + sfx, "r s r s r s r s r s M L257 +",
         "x", (None, "PBODY" + sfx, "PFRUIT" + sfx)),
        ("PFRUIT" + sfx, "L256 s W s W s L10 s", "j", ("PBODY" + sfx,)),
...
BLOCKS = [
    ...
    ("INIT",
     ...
     " L257 N s"                       # F  = -257, no fruit
     " W s"                            # B1 = T
     " W 0 s"                          # marker
     " L256 s W s W s L11 s"          # paint the head green
     + " " + SWAP0 + " " + VREQ,
     "j", ("MAIN",)),
