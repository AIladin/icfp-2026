"""snake gen48 — direct direction-table shift plus top-row INIT.
    ...
    def plan(self):
        ...
        for k, blk in enumerate(BLOCKS):
            ...
            if kind == "scan":
                ...
                below = 1
            rows = []
            # INIT is entered only by the room spawn, which is placed directly on its code row.
            # No wire targets INIT, so its generic entry row was permanently unreachable.
            if name != "INIT":
