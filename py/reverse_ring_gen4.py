"""reverse-a-list v4: the delay ring is two columns wide, and the emit chain turns a corner.
...
def main() -> None:
    ...
    ap.add_argument("--man", default="programs/reverse-ring4.man")
    ap.add_argument("--rooms", default="rooms/reverse-main4")
    ap.add_argument("--netlist", default="programs/reverse-a-list/ring4.eman.toml")
    args = ap.parse_args()
