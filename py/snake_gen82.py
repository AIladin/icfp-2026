"""snake gen82 — attach input to HUB's right for a straight command 2.
...
INX, INY = 15, 15                    # input room B+15 .. B+17, rows 15..17
...
def build(audit: bool = False) -> str:
    ...
    px([(18, 16), (19, 16), (19, 8), (18, 8)], final=(-1, 0), want=11, name="input")
